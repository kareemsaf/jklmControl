# JKLMControl.py
# CREDITS TO DO-Ui for the word list
...
__all__ = ["chat", "set_greet", "send_greet", "info", "typein", "wlist"]
greet = "Hello!"
...
def typein(contents):
    "Types contents into the word you want to write so the bomb doesn't explode."
    pyautogui.click(560, 690)
    keyboard.write(contents)
    keyboard.press_and_release("enter")
